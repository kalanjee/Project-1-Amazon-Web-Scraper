...
#Edit the span and class ids below to pick up the content within the HTML elements. The code is configured for amazon.co.uk product pages and this may differ by category and country. 
def get_title(soup):
    try:
...
#Enter a URL below. Hint: Enter a product that you want to track into Amazon search, and copy paste the URL that is returned.
